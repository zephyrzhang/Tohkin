...
<?php do_action('login_form'); ?>
	<p class="forgetmenot"><label style="color:#666666;"><input name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="90" /> <?php esc_attr_e('Remember Me'); ?></label></p>
	<p class="submit">
